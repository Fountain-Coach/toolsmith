...
public struct IndexedDocument: Codable, Sendable {
  ...
  public init(
    id: String, fileName: String, size: Int, sha256: String? = nil, pages: [IndexedPage]? = nil
  ) {
    self.id = id
...
public struct Matrix: Codable, Sendable {
  ...
  public init(
    bitfields: [BitField]? = nil, enums: [EnumSpec]? = nil, messages: [MatrixEntry],
    ranges: [RangeSpec]? = nil, schemaVersion: String, terms: [MatrixEntry]
  ) {
    self.bitfields = bitfields
    self.enums = enums
